...
#label
music=Label(root,text="", font=("Verdana",15), fg="white", bg="#0f1a2b")
...
Button(root,text="Open Folder", width=15, height=2, font=("verdana",10,"bold"),fg="white",bg="#21b3de",command=open_folder).place(x=330, y=300)

scroll = Scrollbar(music_frame)
playlist = Listbox(music_frame, width=100, font=("verdana",10),bg = "#333333",fg="grey",selectbackground="lightblue",cursor="hand2",bd=0,yscrollcommand=scroll.set)
